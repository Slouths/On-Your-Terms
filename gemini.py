...
#Summarize the content of the terms of service
def summarize_content(content, language):
    language_prompts = {
        'en': "Summarize the terms of service (ToS) for the provided company by highlighting unusual or unexpected clauses that users might be agreeing to. Finally, provide a rating out of 10 based on how user-friendly, transparent, and fair the terms are, with 10 being the ideal terms of service. The rating should consider elements like privacy, data ownership, cancellation policies, and overall fairness:",
    ...
    #Prompt the model to summarize the content
